# =============================================================================
# Step 1 — Clean individual field datasets
# Input:  raw CSVs from BONARES_*, IhingerHof*, and Gladbacherhof**
# Output: one standardised CSV per field in 01_Data/AnalysisData/
# * Koch et al 2025
# * Golicz et al 2023
# =============================================================================
# Fields processed:
#   Signal16 sites   : Wendhausen, Dornburg, Forst, Mariensee (2016-2017) [BONARES]
#   Wendhausen 19-23 : Wendhausen [BONARES]
#   Dornburg 18-23   : Dornburg Vechta combined file [BONARES]
#   Vechta 19-23     : Vechta [BONARES]
#   Reiffenhausen    : Reiffenhausen [BONARES]
#   Mariensee 17-19  : Mariensee [BONARES]
#   Forst 19-20      : Forst [BONARES]
#   Gladbacherhof 21 : Gladbacherhof [Golicz]
#   IhingerHof 16-23 : Ihinger Hof [Koch]
# =============================================================================
...
write.csv(wendhausen_x4, file.path(ANALYSIS_DIR, "fields_wendhausen.csv"), row.names = FALSE)
...
write.csv(dornburg1623, file.path(ANALYSIS_DIR, "fields_dornburg.csv"), row.names = FALSE)
...
write.csv(vechta, file.path(ANALYSIS_DIR, "fields_vechta.csv"), row.names = FALSE)
...
write.csv(reiffenhausen, file.path(ANALYSIS_DIR, "fields_reiffenhausen.csv"), row.names = FALSE) 
...
write.csv(mariensee1719, file.path(ANALYSIS_DIR, "fields_mariensee.csv"), row.names = FALSE) 
...
write.csv(forst1620, file.path(ANALYSIS_DIR, "fields_forst.csv"), row.names = FALSE) 
...
write.csv(gladbacherhof, file.path(ANALYSIS_DIR, "fields_gladbacherhof.csv"), row.names = FALSE) 
...
write.csv(filter(koch25, year >= 2016), file.path(ANALYSIS_DIR, "fields_koch_1223.csv"), row.names = FALSE) 
write.csv(koch25, file.path(ANALYSIS_DIR, "fields_koch_1223.csv"), row.names = FALSE) 
